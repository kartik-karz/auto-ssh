...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.tv_email_id.setTabChangesFocus(True)
        self.tv_password = QtWidgets.QLineEdit(Form)
        self.tv_password.setGeometry(QtCore.QRect(110, 140, 67, 17))
        self.tv_password.setObjectName("tv_password")
        self.tv_password.setTabChangesFocus(True)
        self.tv_password.setEchoMode(QLineEdit.Password)
